...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;94m''𝟏 - 𝐂𝐫𝐚𝐜𝐤 𝐅𝐢𝐥𝐞')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r Emran {P}{b}{loop}{P} - {b}{len(id)}{P}  • OK:{P}{H}{ok}{P} -  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
